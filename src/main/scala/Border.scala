...
case class Border(y1BoxLine: LineSegment, y2BoxLine: LineSegment, x1BoxLine: LineSegment, x2BoxLine: LineSegment, bid: Option[Int] = None, bname: Option[String] = None) extends Geo(name = bname, verbose = false) {
